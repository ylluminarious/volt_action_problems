...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'volt-action-problems.com'
  config.app_name = 'Volt_action_problems'
  config.mailer.from = 'Volt_action_problems <no-reply@volt-action-problems.com>'
  ...
  #
  config.app_secret = 'ygZe3klk67LNeSJhb0EpXiGF9_ckYOnecD39NaxFvWgAg0vyL9A4eR6T-47Dma83olk'
